...
public class TestDonationCreateCustomPageNew {
	...
	@Test
	public void testDonationCreateCustomPageNew() throws Exception {
		...
		selenium.type("id=page_name", selenium.getEval("'Production_GP_CFRP_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Public Title:"));
		assertTrue(selenium.isElementPresent("id=public_title"));
		selenium.type("id=public_title", selenium.getEval("'Production_PT_GP_CFRP_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Page Url:"));
		assertTrue(selenium.isElementPresent("id=slugInput-textBox-value"));
		selenium.type("id=slugInput-textBox-value", selenium.getEval("'production_gp_cfrp_acvv_slug'+Math.floor(Math.random()*10000)"));
		...
		selenium.type("name=amt_section_label2", "Production_Custom_Donation_Page");
		...
		selenium.type("name=thanks_email_from_name", "Production Automated GP Custom Donation Testing");
		verifyTrue(selenium.isTextPresent("Subject:"));
		assertTrue(selenium.isElementPresent("name=thanks_email_subject"));
		selenium.type("name=thanks_email_subject", "Production GP Custom Donation Production Tests!!!");
