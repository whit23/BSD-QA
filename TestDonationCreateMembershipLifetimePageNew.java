...
public class TestDonationCreateMembershipLifetimePageNew {
	...
	@Test
	public void testDonationCreateMembershipLifetimePageNew() throws Exception {
		...
		selenium.type("id=page_name", selenium.getEval("'Production_GP_MFRP_LT_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Public Title:"));
		assertTrue(selenium.isElementPresent("id=public_title"));
		selenium.type("id=public_title", selenium.getEval("'Production_GP_MFRP_LT_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Page Url:"));
		assertTrue(selenium.isElementPresent("id=slugInput-textBox-value"));
		selenium.type("id=slugInput-textBox-value", selenium.getEval("'production_gp_mfrp_lt_ACVV_slug'+Math.floor(Math.random()*10000)"));
		...
		selenium.type("name=membership_label", "Production Membership-Lifetime Page");
		...
		selenium.select("id=membership_is_lifetime", "label=Yes");
		...
		selenium.type("name=thanks_email_from_name", "Production Automated GP Membership-Lifetime Donation Testing");
		verifyTrue(selenium.isTextPresent("Subject:"));
		assertTrue(selenium.isElementPresent("name=thanks_email_subject"));
		selenium.type("name=thanks_email_subject", "Production GP Membership-Lifetime Donation Tests!!!");
