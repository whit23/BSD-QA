...
public class TestDonationCreateRecurringSimplePageNew {
	...
	@Test
	public void testDonationCreateRecurringSimplePageNew() throws Exception {
		...
		selenium.type("id=page_name", selenium.getEval("'Production_GP_SFRP_R_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Public Title:"));
		assertTrue(selenium.isElementPresent("id=public_title"));
		selenium.type("id=public_title", selenium.getEval("'Production_GP_SFRP_R_ACVV'+Math.floor(Math.random()*10000)"));
		verifyTrue(selenium.isTextPresent("Page Url:"));
		assertTrue(selenium.isElementPresent("id=slugInput-textBox-value"));
		selenium.type("id=slugInput-textBox-value", selenium.getEval("'production_gp_sfrp_r_acvv_slug'+Math.floor(Math.random()*10000)"));
		...
		verifyTrue(selenium.isTextPresent("Custom"));
		assertTrue(selenium.isElementPresent("id=type-custom"));
		selenium.click("id=type-custom");
		assertEquals("on", selenium.getValue("id=type-custom"));
		verifyTrue(selenium.isTextPresent("Setup a Custom Contribution Page"));
		verifyTrue(selenium.isTextPresent("Section Label"));
		assertTrue(selenium.isElementPresent("name=amt_section_label2"));
		selenium.type("name=amt_section_label2", "Production_Simple_Recurring_Donation_Page");
		verifyTrue(selenium.isTextPresent("Display Columns"));
		selenium.select("name=display_columns", "label=4");
		verifyTrue(selenium.isTextPresent("Add Amount Option"));
		selenium.type("name=custom_amt", "15.00");
		selenium.type("name=custom_label", "Freshman");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "115.00");
		selenium.type("name=custom_label", "Sophomore");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "215.00");
		selenium.type("name=custom_label", "Junior");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "315.00");
		selenium.type("name=custom_label", "Senior");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "415.00");
		selenium.type("name=custom_label", "Bachelor");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "515.00");
		selenium.type("name=custom_label", "Masters");
		selenium.click("name=add_amount");
		selenium.type("name=custom_amt", "615.00");
		selenium.type("name=custom_label", "PHD");
		selenium.click("name=add_amount");
		...
		selenium.type("name=thanks_email_from_name", "Production Automated GP Simple Recurring Donation Testing");
		verifyTrue(selenium.isTextPresent("Subject:"));
		assertTrue(selenium.isElementPresent("name=thanks_email_subject"));
		selenium.type("name=thanks_email_subject", "Production GP Simple Recurring Donation Tests!!!");
