...
public class TestDonationMakeSFRPACVVViaApplicationProgrammingInterface {
	...
	@Test
	public void testDonationMakeSFRPACVVViaApplicationProgrammingInterface() throws Exception {
		...
		selenium.type("name=slug", "fwork-42943_cf_hidden_text_all");
		...
		selenium.type("id=lastname", selenium.getEval("\"Whitfield\"+ Math.floor(Math.random()*10000)"));
		...
		selenium.select("id=cc_expir_year", "label=2017");
		...
		selenium.click("css=#recurring_acknowledge");
