...
public class TestDonationMakeSFRPCCVVViaApplicationProgrammingInterface {
	...
	@Test
	public void testDonationMakeSFRPCCVVViaApplicationProgrammingInterface() throws Exception {
		...
		selenium.type("name=slug", "donate_api_ccvv");
		...
		selenium.type("id=lastname", selenium.getEval("'WhitfieldAPICCVV'+Math.floor(Math.random()*10000)"));
