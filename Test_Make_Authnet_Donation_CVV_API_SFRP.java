...
public class Test_Make_Authnet_Donation_CVV_API_SFRP {
	private Selenium selenium;

	@Before
	public void setUp() throws Exception {
		WebDriver driver = new FirefoxDriver();
		String baseUrl = "https://test4.bluestatedigital.com/ctl/Core/AdminLogin?m=success";
		selenium = new WebDriverBackedSelenium(driver, baseUrl);
	}

	@Test
	public void test_Make_Authnet_Donation_CVV_API_SFRP() throws Exception {
		selenium.open("https://test4.bluestatedigital.com/donate-api-contrib.html?nomin=1");
		...
		selenium.type("id=lastname", selenium.getEval("\"WhitfieldAPISFRPACVV\"+ Math.floor(Math.random()*10000) + \"@bluestatedigital.com\";"));
		...
		selenium.type("id=email", selenium.getEval("\"jwhitfield+apisfrpacvv\"+ Math.floor(Math.random()*10000) + \"@bluestatedigital.com\";"));
		...
		assertTrue(selenium.isElementPresent("id=amt_other_text"));
		selenium.type("id=amt_other_text", "125.00");
